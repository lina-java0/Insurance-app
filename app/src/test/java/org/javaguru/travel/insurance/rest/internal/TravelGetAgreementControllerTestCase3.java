...
public class TravelGetAgreementControllerTestCase3 extends TravelGetAgreementControllerTestCase {
    ...
    public void shouldGetAgreement() throws Exception {
        executeAndCompare("UNKNOWN UUID", true);
    }

    @Override
    protected String getTestCaseFolderName() {
        return "internal/test_case_3";
    }
}
